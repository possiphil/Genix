...
namespace Genix.Editor.Profiling
{
    ...
    internal static class GenerationProfileCatalogService
    {
        ...
        public static GenerationProfileCatalog GetOrCreate()
        {
            ...
            AssetFileService.EnsureFolder(ProjectContentPaths.Profiles);
        ...
        public static void Refresh()
        {
            ...
            List<GenerationProfileReport> reports = AssetFileService.FindAssets<GenerationProfileReport>(ProjectContentPaths.Profiles)
        ...
        {
            GenerationProfileCatalog catalog = GetOrCreate();
            string[] guids = AssetDatabase.FindAssets($"t:{nameof(GenerationProfileReport)}", new[] { ProjectContentPaths.Profiles });
