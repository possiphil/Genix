...
namespace Genix.SpaceFoundation.Editor
{
    ...
    public sealed class SfsAreaCacheAsset : ScriptableObject
    {
        ...
        /// <summary>Reconstructs a placement area from a matching persistent cache entry.</summary>
        /// <param name="key">Stable identifier of the SFS source and area-build configuration.</param>
        /// <param name="sourceInfo">Current spatial source metadata attached to the reconstructed area.</param>
        /// <param name="settings">Area-build settings used by the reconstructed area.</param>
        /// <param name="subspace">Resolved SFS voxel cells referenced by the cached surfaces.</param>
        /// <param name="voxelSize">World-space edge length of one SFS voxel.</param>
        /// <param name="isSourceCollider">Predicate used to recognize source geometry during projection.</param>
        /// <param name="area">Reconstructed placement area when the cache entry is valid.</param>
        /// <returns><see langword="true"/> when the cached area was reconstructed successfully.</returns>
        public bool TryGet(
            string key,
        ...
        /// <summary>Stores a reconstructable placement area and enforces the persistent cache limits.</summary>
        /// <param name="key">Stable identifier of the SFS source and area-build configuration.</param>
        /// <param name="area">Placement area to serialize.</param>
        /// <param name="maxEntries">Maximum number of retained entries.</param>
        /// <param name="maxSurfaceCells">Maximum combined number of retained floor and ceiling cells.</param>
        public void Store(
            string key,
            PlacementArea area,
            int maxEntries,
        ...
        /// <summary>Removes all persistent placement-area entries.</summary>
